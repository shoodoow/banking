...
const SideBar = ({ user }: SiderbarProps) => {
    ...
    return (
        <section className='sticky left-0 top-0 flex h-screen  flex-col justify-between border-r border-gray-300 bg-white pt-8 text-white max-md:hidden sm:p-4 xl:p-6 2xl:w-[355px]   '>
